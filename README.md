...
* **1. Clone the Repository:**
    git clone [https://github.com/mumberestanny-eng/workshop-cost-estimator.git]
          (https://github.com/mumberestanny-eng/workshop-cost-estimator.git)
    cd workshop-cost-estimator
